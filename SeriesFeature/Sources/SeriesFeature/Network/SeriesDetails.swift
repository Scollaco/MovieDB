...
public struct SeriesDetails {
  ...
  public struct SeriesVideoResponse: Decodable {
    public let results: [SeriesVideo]
  }
  
  public struct SeriesVideo: Decodable {
  ...
  public let videos: SeriesVideoResponse?
...
extension SeriesDetails: Decodable {
  public init(from decoder: Decoder) throws {
    ...
    self.videos = try container.decodeIfPresent(SeriesVideoResponse.self, forKey: .videos)
